...
class fsociety:
    def __init__(self):
       ...
       }--------------{+} Coded By Error-4-You {+}--------------{
       }--------{+}  GitHub.com/Error-4-You/fsociety {+}--------{
    ''' + color.END + '''
    ...
    Yb      Yb   dP 88 Y88   88   88"Yb  88 88""Yb o.`Y8b
     ...
     ''')
        contributorsURL = 'https://api.github.com/repos/Error-4-You/fsociety/contributors'
    ...
    def update(self):
        os.system("git clone --depth=1 https://github.com/Error-4-You/fsociety.git")
...
class crips:
    ...
    def __init(self):
        ...
        self.gitRepo = "https://github.com/Error-4-You/Crips.git"
